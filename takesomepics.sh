...
fswebcam -q -r 1920x1080 --no-banner -d $CAMERA $TL/pics/$MONTH/$DAY/$TIME.jpg >> $TL/tl_info.log 2>&1
sleep 30
fswebcam -q -r 1920x1080 --no-banner -d $CAMERA $TL/pics/$MONTH/$DAY/`date +"%H%M%S"`.jpg >> $TL/tl_info.log 2>&1
